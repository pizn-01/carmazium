...
export default function SellerMessagesPage() {
    // Mock Data
    const conversations = [
        { id: 1, name: "David Miller", lastMsg: "When can I come see the BMW?", time: "11:15 AM", unread: 1, avatar: null, active: true },
        { id: 2, name: "Sarah Jenkins", lastMsg: "Thanks for the quick reply.", time: "Yesterday", unread: 0, avatar: null, active: false },
    ]

    const [messages, setMessages] = useState([
        { id: 1, text: "Hi, is the 2020 BMW M2 Competition still available?", sender: "them", time: "11:00 AM" },
        { id: 2, text: "Yes, it is! Would you like to schedule a test drive?", sender: "me", time: "11:05 AM" },
        { id: 3, text: "That would be great. When can I come see the BMW?", sender: "them", time: "11:15 AM" },
    ])
                    ...
                    <div className="flex-1 glass-card flex flex-col overflow-hidden">
                        ...
                        <div className="p-4 border-b border-white/10 flex justify-between items-center bg-slate-800/30">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="font-bold text-white">David Miller</h3>
